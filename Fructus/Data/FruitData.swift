...
struct FruitData {
 ...
 """,
   ...
   """,
	...
	/// Rpevent outside construction by making the ini private
	private init(){}
	
	/// Static subscript for using `fruitData` property
	static subscript<T>(dynamicMember keyPath: KeyPath<FruitData, T>) -> T {
		FruitData()[keyPath: keyPath]
	}
}
